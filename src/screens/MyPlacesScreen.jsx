...
const MyPlacesScreen = () => {
  ...
  const [places, setPlaces] = useState([
    {
      id: 1,
      title: "Geek Out! Argentina",
      coords: { latitude: -34.555579051686586, longitude: -58.461540799929494 },
      address: "Blanco Encalada 2518, C1425 Cdad. Autónoma de Buenos Aires",
    },
    {
      id: 2,
      title: "Fuera de tiempo",
      coords: { latitude: -34.54776236446238, longitude: -58.5538693790271 },
      address: "Blanco Encalada 2518, C1425 Cdad. Autónoma de Buenos Aires",
    },
  ]);
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Encontranos en:</Text>
      <View style={styles.inputContainer}>
        ...
        <Pressable onPress={getLocation}>
          <Icon name="location-on" color={colors.azulMarino} size={24} />
        </Pressable>
        <Pressable onPress={savePlace}>
          <Icon name="add-circle" color={colors.azulMarino} size={32} />
        </Pressable>
      </View>
      <Text style={styles.subtitle}>Donde encontrarnos:</Text>
      <FlatList
        data={places}
...
const styles = StyleSheet.create({
  ...
  textInput: {
    borderWidth: 1,
    borderColor: colors.celestePastel,
    borderRadius: 20,
    padding: 8,
    width: "80%",
    paddingLeft: 16,
